...
class ReportView(RetrieveAPIView):
    """ This view gives us overall summary for all the items purchased by user """
...
class CategoryView(ListAPIView):
    """ This view gives us category wise summary for each user """
...
class MonthlyReportView(APIView):
    ...
    For custom reports, analytics, etc. there is no model instance to retrieve or create, so APIView is preferred.
    """
